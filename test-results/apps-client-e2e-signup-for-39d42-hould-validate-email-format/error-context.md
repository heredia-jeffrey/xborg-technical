...
- Name: Signup Form Submission >> should validate email format
- Location: C:\Users\hered\playground\xborg\xborg-backend-challenge-main\apps\client\e2e\signup-form-submission.spec.ts:146:7
...
Call log:
  ...
  - waiting for locator('#email-error')
    9 × locator resolved to <div id="email-error" class="error-message">Must be a valid email</div>
      - unexpected value "hidden"

    at C:\Users\hered\playground\xborg\xborg-backend-challenge-main\apps\client\e2e\signup-form-submission.spec.ts:157:48
```
